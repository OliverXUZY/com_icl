...
#declare -a models=("meta-llama/Llama-2-7b-hf" "meta-llama/Llama-2-13b-hf" "mistralai/Mistral-7B-v0.1" "mistralai/Mistral-7B-Instruct-v0.2")
declare -a models=("meta-llama/Llama-2-13b-hf" "mistralai/Mixtral-8x7B-v0.1" "meta-llama/Llama-2-70b-hf")
# declare -a models=("mistralai/Mistral-7B-v0.1" )
# declare -a models=("mistralai/Mixtral-8x7B-v0.1" "mistralai/Mixtral-8x7B-Instruct-v0.1" "meta-llama/Llama-2-70b-hf")
#"declare -a models=("meta-llama/Llama-2-70b-hf")
